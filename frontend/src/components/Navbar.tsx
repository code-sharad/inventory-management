...
export default function Navbar() {
    ...
    return (
        <div className="flex gap-1">
            <div className="hidden md:block  inset-y-0 z-[1000] left-0 w-52 border-r bg-zinc-50">
                <Header />
            ...
            <div className="flex-1 min-h-screen">
                <div className="m-4 pt-12 overflow-x-hidden overflow-y-auto">
                    {/* <Header /> */}
                    ...
                    <button onClick={() => setIsOpen(!isOpen)} className="p-4">
                        ...
                        <nav className={`bg-black/80 backdrop-blur-lg text-white fixed  top-0 left-0 h-full w-64  transform transition-transform duration-300 ease-in-out ${isOpen ? 'translate-x-0' : '-translate-x-full'}`}>
